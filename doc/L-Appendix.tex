...
\begin{table}[H]
    \centering
    \resizebox{\textwidth}{!}{
        \input{tables/other-strategies-decriptions}
    }
    \caption{Description of Other Tested Strategies}
\end{table}

\subsubsection{Other Tested Strategies Results}

\begin{table}[H]
    \centering
    \resizebox{\textwidth}{!}{
        \input{tables/other-strategies-results-1}
    }
    \caption{Results of Other Tested Strategies I}
\end{table}

\begin{table}[H]
    \centering
    \resizebox{\textwidth}{!}{
        \input{tables/other-strategies-results-2}
    }
    \caption{Results of Other Tested Strategies II}
\end{table}