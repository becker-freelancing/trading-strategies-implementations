...
public class AtrBasedRLLongAndShortStrategy extends RLLongAndShortStrategy {

    private final Indicator<Num> atr;
    private final Decimal atrMultiplier;
    private final Decimal takeProfitMultiplier;

    public AtrBasedRLLongAndShortStrategy(StrategyParameter strategyParameter, RLPredictor rlPredictor, PositionBehaviour positionBehaviour, int atrPeriod, Decimal atrMultiplier, Decimal takeProfitMultiplier) {
