...
public class ClassificationLiveStrategyCreator implements StrategyCreator {
    ...
    public String strategyName() {
        return "live_classification_strategy";
    }
    ...
    public TradingStrategy build(StrategyParameter strategyParameter) {
        return new ClassificationLiveStrategy(
                strategyParameter,
                ...
                new LiveClassificationPredictor()
        );
    }
}
