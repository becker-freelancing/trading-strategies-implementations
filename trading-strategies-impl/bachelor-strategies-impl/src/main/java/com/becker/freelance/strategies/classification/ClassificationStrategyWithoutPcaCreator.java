...
public class ClassificationStrategyWithoutPcaCreator implements StrategyCreator {
    ...
    public String strategyName() {
        return "classification_strategy_without_pca";
    }
    ...
    public TradingStrategy build(StrategyParameter strategyParameter) {
        return new ClassificationStrategy(
                ...
                new BufferedClassificationWithoutPcaPredictor()
        );
    }
}
