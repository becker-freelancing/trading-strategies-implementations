...
public class SequenceLiveRegressionStrategyCreator implements StrategyCreator {
    ...
    public String strategyName() {
        return "live_sequence_regression";
    }
    ...
    public TradingStrategy build(StrategyParameter strategyParameter) {
        return new SequenceLiveRegressionStrategy(
                strategyParameter,
                new LiveRegressionPredictor(),
