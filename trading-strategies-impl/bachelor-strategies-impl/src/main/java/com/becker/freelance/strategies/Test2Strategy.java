...
public class Test2Strategy extends BaseStrategy {

    public Test2Strategy() {
        super("Test2", new PermutableStrategyParameter(
                List.of(
    ...
    private Test2Strategy(Map<String, Decimal> parameters){
        super(parameters);
    }
    ...
    public BaseStrategy forParameters(Map<String, Decimal> parameters) {
        return new Test2Strategy(parameters);
    }
}
