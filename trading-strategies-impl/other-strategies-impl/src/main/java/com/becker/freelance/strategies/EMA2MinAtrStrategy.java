...
public class EMA2MinAtrStrategy extends BaseStrategy {


    private final EMAIndicator shortSma;
    private final EMAIndicator longSma;
    private final ATRIndicator atrIndicator;
    private final Num minAtrValue;

    public EMA2MinAtrStrategy(StrategyParameter parameter, int shortMaPeriod, int longMaPeriod, double minAtrValue) {
        super(parameter);
        ...
        this.minAtrValue = DecimalNum.valueOf(minAtrValue);
        this.atrIndicator = new ATRIndicator(barSeries, 14);
    }
    ...
    public Optional<EntrySignalBuilder> internalShouldEnter(EntryExecutionParameter entryParameter) {
        ...
        if (atrIndicator.getValue(barCount).isLessThan(minAtrValue)) {
