...
public class EMA2WithLongEmaFilterStrategyCreator implements StrategyCreator {
    ...
    public String strategyName() {
        return "2_EMA_Strategy_with_long_EMA_filter";
    }

    @Override
    public ValidStrategyInitParameters strategyParameters() {
        return new ValidStrategyInitParameters(
                EMA2WithLongEmaFilterStrategyCreator::shortMaLessThanLongMaValidation,
    ...
    public TradingStrategy build(StrategyParameter strategyParameter) {
        return new EMA2WithLongEmaFilterStrategy(
                strategyParameter,
