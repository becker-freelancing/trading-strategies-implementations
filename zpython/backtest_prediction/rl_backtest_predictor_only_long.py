...
def read_all():
    if os.path.exists("./merged_backtest_only_long.csv"):
        df = pd.read_csv("./merged_backtest_only_long.csv")
    ...
    merged_copy.to_csv("./merged_backtest_only_long.csv", index=False)
    return merged
