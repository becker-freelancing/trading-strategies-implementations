...
def slice_data_multiple(df, train_length, pred_length, split_idxs):
    return [slice_data(df, split_idx, train_length, pred_length) for split_idx in split_idxs]
...
def execute_for_regressors(df, train_length, pred_length, split_idxs, tests_per_model, errors, regressor_names,
                           regressors):
